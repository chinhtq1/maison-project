...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="mb-2">
          <a href="{{ route('admin_slide','0')}}" class="btn btn-info"><i class="far fa-plus-square"></i> Thêm Slide</a>
        </div>
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td class="col-300">
                              ...
                              <p><b>Ngày xuất bản: </b>{{ App\Helper\Helper::render_time_to_vietnamese(!is_null($slide->date_public)?$slide->date_public:null) }}</p>

                              </div>
                          </td>
                          <td class="col-300">
                            <div class="btn-group">
                                <a type="button" class="btn btn-info" href="{{ route('admin_slide',$slide->id)}}"><i class="fas fa-edit" title="Edit"></i></a>
                                @if(!$slide->is_public)
                                <a type="button" class="btn btn-warning"  href="{{ route('admin_slide',$slide->id)}}?public"  ><i class="fas fa-lock" title="Trạng thái: chưa xuất bản" style="color:#fff"></i></a>
                                @else
                                <a type="button" class="btn btn-success"  href="{{ route('admin_slide',$slide->id)}}?unpublic"><i class="fas fa-clock" title="Trạng thái: đã xuất bản"  style="color:#fff"></i></a>
                                @endif
